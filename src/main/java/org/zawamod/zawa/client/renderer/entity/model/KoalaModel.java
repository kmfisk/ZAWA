...
public abstract class KoalaModel extends SegmentedModel<KoalaEntity> {
    ...
    @Override
    public void setupAnim(KoalaEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.neck.xRot = headPitch * ((float) Math.PI / 180F) / 2F - 0.13F;
        this.head.xRot = headPitch * ((float) Math.PI / 180F) / 2F + 0.24F;
        this.neck.yRot = netHeadYaw * ((float) Math.PI / 180F) / 2F;
        this.head.yRot = netHeadYaw * ((float) Math.PI / 180F) / 2F;
        if (limbSwingAmount <= 0.05f) {
            this.neck.xRot = MathHelper.cos(entity.tickCount) * 0.5f; // todo ???? this doesn't work
        }
    }
    ...
    public static class Adult extends KoalaModel {
        public Adult() {
            ...
            this.neckUnder.setPos(0.0F, 3.2F, -3.3F);
            ...
            this.leg1.setPos(0.0F, 5.7F, -1.5F);
            ...
            this.foot1.setPos(0.0F, 3.52F, 1.0F);
            ...
            this.hand1.setPos(0.0F, 4.0F, -1.8F);
            ...
            this.forearm2.setPos(0.02F, 4.5F, 1.6F);
            ...
            this.foot2.setPos(0.0F, 3.52F, 1.0F);
            ...
            this.nose.setPos(0.0F, 1.5F, -1.6F);
            ...
            this.thight1.setPos(3.0F, 2.9F, 3.3F);
            ...
            this.ear1.setPos(1.4F, -1.2F, -2.4F);
            ...
            this.leg2.setPos(0.0F, 5.7F, -1.5F);
            ...
            this.forearm1.setPos(-0.02F, 4.5F, 1.6F);
            ...
            this.thight2.setPos(-3.0F, 2.9F, 3.3F);
            ...
            this.arm1.setPos(2.4F, 0.2F, 1.6F);
            ...
            this.toe1.setPos(0.2F, 0.42F, 0.0F);
            ...
            this.neck.setPos(0.0F, -0.7F, 0.1F);
            ...
            this.booty.setPos(0.0F, 0.3F, 5.2F);
            ...
            this.belly.setPos(0.0F, -3.5F, 7.0F);
            ...
            this.snout.setPos(0.0F, 1.1F, -4.5F);
            ...
            this.hand2.setPos(0.0F, 4.0F, -1.8F);
            ...
            this.toe2.setPos(-0.2F, 0.42F, 0.0F);
            ...
            this.ear2.setPos(-1.4F, -1.2F, -2.4F);
        ...
        public void setupAnim(KoalaEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
            ...
            this.neck.xRot = MathHelper.cos((limbSwing * speed * 0.3F) + (float) Math.PI) * (degree * 0.05F) * limbSwingAmount * 0.5F + -0.14F;
            this.arm1.xRot = MathHelper.cos((limbSwing * speed * 0.15F) + (float) Math.PI) * (degree * 0.9F) * limbSwingAmount * 0.5F + 0.06F;
            this.forearm1.xRot = MathHelper.cos(2.0F + (limbSwing * speed * 0.15F) + (float) Math.PI) * (degree * 1.5F) * limbSwingAmount * 0.5F + -0.1F;
            this.hand1.xRot = MathHelper.cos(5.0F + (limbSwing * speed * 0.15F) + (float) Math.PI) * (degree * -1.5F) * limbSwingAmount * 0.5F + 0.06F;
            this.arm2.xRot = MathHelper.cos((limbSwing * speed * 0.15F) + (float) Math.PI) * (degree * -0.9F) * limbSwingAmount * 0.5F + 0.06F;
            this.forearm2.xRot = MathHelper.cos(2.0F + (limbSwing * speed * 0.15F) + (float) Math.PI) * (degree * -1.5F) * limbSwingAmount * 0.5F + -0.1F;
            this.hand2.xRot = MathHelper.cos(5.0F + (limbSwing * speed * 0.15F) + (float) Math.PI) * (degree * 1.5F) * limbSwingAmount * 0.5F + 0.06F;
            this.thight1.xRot = MathHelper.cos(2.0F + (limbSwing * speed * 0.15F) + (float) Math.PI) * (degree * -1.5F) * limbSwingAmount * 0.5F + 0.1F;
            this.leg1.xRot = MathHelper.cos((limbSwing * speed * 0.15F) + (float) Math.PI) * (degree * -1.3F) * limbSwingAmount * 0.5F + 0.05F;
            this.foot1.xRot = MathHelper.cos((limbSwing * speed * 0.15F) + (float) Math.PI) * (degree * 2.0F) * limbSwingAmount * 0.5F;
            this.thight2.xRot = MathHelper.cos(2.0F + (limbSwing * speed * 0.15F) + (float) Math.PI) * (degree * 1.5F) * limbSwingAmount * 0.5F + 0.1F;
            this.leg2.xRot = MathHelper.cos((limbSwing * speed * 0.15F) + (float) Math.PI) * (degree * 0.0F) * limbSwingAmount * 0.5F + 0.05F;
            this.foot2.xRot = MathHelper.cos((limbSwing * speed * 0.15F) + (float) Math.PI) * (degree * -2.0F) * limbSwingAmount * 0.5F;
            this.body.y = MathHelper.cos((limbSwing * speed * 0.3F) + (float) Math.PI) * (degree * 0.01F) * limbSwingAmount * 0.5F + 14.5F;
        }
    }
    ...
    public static class Child extends KoalaModel {
        ...
        public void setupAnim(KoalaEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
            ...
            this.neck.xRot = MathHelper.cos((limbSwing * speed * 0.3F) + (float) Math.PI) * (degree * 0.05F) * limbSwingAmount * 0.5F + -0.14F;
            this.arm1.xRot = MathHelper.cos((limbSwing * speed * 0.15F) + (float) Math.PI) * (degree * 0.9F) * limbSwingAmount * 0.5F + 0.06F;
            this.forearm1.xRot = MathHelper.cos(2.0F + (limbSwing * speed * 0.15F) + (float) Math.PI) * (degree * 1.0F) * limbSwingAmount * 0.5F + -0.2F;
            this.hand1.xRot = MathHelper.cos(5.0F + (limbSwing * speed * 0.15F) + (float) Math.PI) * (degree * -1.5F) * limbSwingAmount * 0.5F + 0.06F;
            this.arm2.xRot = MathHelper.cos((limbSwing * speed * 0.15F) + (float) Math.PI) * (degree * -0.9F) * limbSwingAmount * 0.5F + 0.06F;
            this.forearm2.xRot = MathHelper.cos(2.0F + (limbSwing * speed * 0.15F) + (float) Math.PI) * (degree * -1.0F) * limbSwingAmount * 0.5F + -0.2F;
            this.hand2.xRot = MathHelper.cos(5.0F + (limbSwing * speed * 0.15F) + (float) Math.PI) * (degree * 1.5F) * limbSwingAmount * 0.5F + 0.06F;
            this.thight1.xRot = MathHelper.cos(2.0F + (limbSwing * speed * 0.15F) + (float) Math.PI) * (degree * -1.5F) * limbSwingAmount * 0.5F + 0.1F;
            this.leg1.xRot = MathHelper.cos((limbSwing * speed * 0.15F) + (float) Math.PI) * (degree * -0.8F) * limbSwingAmount * 0.5F + 0.2F;
            this.thight2.xRot = MathHelper.cos(2.0F + (limbSwing * speed * 0.15F) + (float) Math.PI) * (degree * 1.5F) * limbSwingAmount * 0.5F + 0.1F;
            this.leg2.xRot = MathHelper.cos((limbSwing * speed * 0.15F) + (float) Math.PI) * (degree * 0.8F) * limbSwingAmount * 0.5F + 0.2F;
            this.body.y = MathHelper.cos((limbSwing * speed * 0.3F) + (float) Math.PI) * (degree * 0.01F) * limbSwingAmount * 0.5F + 19.2F;
        }
    }
}
